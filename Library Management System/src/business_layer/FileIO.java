	...
	private void readDataArrays() {
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				switch (itemType) {
				case "book":
					items[index] = new Book(itemNum, itemTitle, itemType, itemPriority, itemAuthorGenre,
							itemPublisherProducer);
					break;
				case "magazine":
					items[index] = new Magazine(itemNum, itemTitle, itemType, itemPriority, itemAuthorGenre,
							itemPublisherProducer);
					break;
				default:
